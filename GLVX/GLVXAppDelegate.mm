...
namespace {
    ...
    Slider sl11(glv::Rect(100, 20));
    Slider2D sl21(glv::Rect(100, 100), 0.5, 0.5);
    Button btn1(glv::Rect(20, 20), true);
    Button btn2(glv::Rect(20, 20), false);
    Button btn3(glv::Rect(20, 20), false, draw::check);
    SliderGrid<3> sg31(glv::Rect(100)), sg32(glv::Rect(100)), sg33(glv::Rect(100));
    SliderGrid<2> sg21(glv::Rect(100));
...
- (void)applicationDidFinishLaunching:(NSNotification *)aNotification
{
    ...
    _controller = [[GLVXWindowController alloc] initWithGLV:&top];
